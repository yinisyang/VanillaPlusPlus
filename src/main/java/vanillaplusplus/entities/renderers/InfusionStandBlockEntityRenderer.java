...
public class InfusionStandBlockEntityRenderer extends BlockEntityRenderer<InfusionStandBlockEntity> {

    public InfusionStandBlockEntityRenderer(BlockEntityRenderDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(InfusionStandBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        matrices.push();
