...
public class SteelScaffoldBlock extends Block {
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if ((Integer)blockState.get(DISTANCE) == 20) {
            if ((Integer)state.get(DISTANCE) == 20) {
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return calculateDistance(world, pos) < 20;
    }
    ...
    public static int calculateDistance(BlockView world, BlockPos pos) {
        ...
        int i = 20;
        if (blockState.isOf(BlockRegistry.STEEL_SCAFFOLD)) {
        ...
        while(var5.hasNext()) {
            ...
            if (blockState2.isOf(BlockRegistry.STEEL_SCAFFOLD)) {
    ...
    static {
        DISTANCE = IntProperty.of("steel_scaffold_distance", 0, 20);
